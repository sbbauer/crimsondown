...
Welcome to the _R Markdown_ thesis template. This template is based on the Harvard Graduate School of Arts and Sciences [thesis formatting guidelines](https://gsas.harvard.edu/degree-requirements/dissertations/formatting-your-dissertation), from which a [LaTeX class](https://github.com/kolesarm/harvard-gsas-thesis) was written, but hopefully it will provide a nicer interface for those that have never used TeX or LaTeX before. The structure of this package and most of this document comes directly from Ben Marwick's [huskydown package](https://github.com/benmarwick/huskydown). 
